...
libraries<-data.frame(Version=sapply(names(libraries),package_version_ch))
...
```{r ggpair_plot,include=FALSE, fig.cap='Visualizing variables.',message=FALSE, fig.align='center', fig.width=12, fig.height=12}
...
In order to obtain the best prediction over validating and testing data, three models were evaluated. Decision three, naive Bayes and random forest were selected. System time employed for every model training was recorded. As it can be seen in next table, both naive Bayes and random forest modeling are high system time consuming. 
